      ...
      <div className="App">
        <div className="headerBoarder">
          <div className="header">
            <a href="" className="homeLink"><strong>Home</strong></a>
            <a href="">Technology</a>
            <a href="">Creativity</a>
        ...
        <div className="container">
          <div className="hero">
            <div className="leftHero">
              ...
              politics to creativity and more - whatever your interest, we&apos;ve got you covered.
              </p>
            ...
            <div className="articleBox">
              ...
              <div className="textBox">
                <div>
                  ...
                  <p>At 5:30 am, on any morning I can handle it, I&apos;ll slip out of
                  the dark mouth of my covers and creep trough the silver lig..
                  </p>
                </div>
            ...
            <div className="articleBox">
              ...
              <div className="textBox">
                <div>
                  ...
                  <p>Around the world, the victims are becoming
